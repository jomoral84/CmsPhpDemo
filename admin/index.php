...
<body>
 ...
 <div id="wrapper">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="panel panel-green">
            ...
            /*      $query = "SELECT * FROM comments";
                  ...
                  $comments_count = getAllPostUserComments();
          ...
          <div class="panel panel-red">
            <div class="panel-heading">
             ...
             /*     $query = "SELECT * FROM categories";
                  ...
                  $categories_count = getAllUserCategories();
  ...
  /*      $query = "SELECT * FROM posts WHERE post_status = 'published'";
       ...
       $post_published_count = countRecords(getAllUserPublishedPosts());
       $post_draft_count = countRecords(getAllUserDraftPosts());
        $unapproved_comment_count = countRecords(getAllUserApprovedPostsComments());
        $approved_comment_count = countRecords(getAllUserUnapprovedPostsComments());   
